/**
 * COMPONENTE INDOOR MAP - MAPA VECTORIAL SVG CON DIJKSTRA
 * Sin cambios en lógica. Solo ajustes de layout.
 */
...
// ─── Procesadores GeoJSON (sin cambios) ──────────────────────────────────────
...
export default function IndoorMap({ origen_id, destino_id, soloAccesible = false }: IndoorMapProps) {
  ...
  // ── AJUSTE: El mapa ahora ocupa TODO el espacio del contenedor ──────────────
  const svgHeight = screenHeight * 0.58;
    ...
    <View style={styles.container}>
      ...
      >
        <Svg width={svgWidth} height={svgHeight}>
          ...
          {/* 3. Ruta activa calculada por Dijkstra */}
          {activeRouteString ? (
            <G>
              <Polyline
